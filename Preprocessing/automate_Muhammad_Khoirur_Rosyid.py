...
PROCESSED_DATA_PATH = os.path.join(OUTPUT_DIR, "ObesityDataSet_processed.csv")
...
def preprocess_data(df):
    ...
    final_columns = numerical_features + encoded_columns.tolist()
...
# SAVE OUTPUT
def save_output(processed_df, mapping_df):

    os.makedirs(OUTPUT_DIR, exist_ok=True)

    processed_df.to_csv(PROCESSED_DATA_PATH, index=False)

    mapping_df.to_csv(LABEL_MAPPING_PATH, index=False)
...
def main():
    ...
    save_output(processed_df, mapping_df)
